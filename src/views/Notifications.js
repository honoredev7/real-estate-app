        ...
        content={
          <div className="header text-center">
            ...
            <p className="category">
              Veuillez consulter ci-dessous vos notifications.
            </p>
          </div>
        }
      />
      <div className="content">
        <NotificationAlert ref={notificationAlert} />
          <Row md={1} xs={12}>
            <Card>
              <CardHeader>
                <CardTitle tag="h4" style={{fontSize:22, fontWeight:900}}>Notifications relatives au Compte</CardTitle>
              </CardHeader>
              <CardBody>
                <Alert color="info">
          ...
          <Row md={1} xs={12}>
            <Card>
              <CardHeader>
                <CardTitle tag="h4" style={{fontSize:22, fontWeight:900}}>Notifications relatives aux Opérations</CardTitle>
              </CardHeader>
              <CardBody>
