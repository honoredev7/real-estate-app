...
const thead = ["Locataire", "Pays", "Ville", "Appartement", "Mois", "Etat de payement", "Montant"];
const tbody = [
  {
    className: "table-success",
    data: ["Dakota Rice", "Niger", "Oud-Turnhout", "Villa9", "Juillet", "Payé", "160 000 FCFA"],
  },
  {
    className: "",
    data: ["Minerva Hooper", "Curaçao", "Sinaai-Waas", "Villa19", "Août", "En Attente", "216 000 FCFA"],
  },
  // {
